    ...
    <div>
      ...
      <div id="slider">
        <swiper :options="swiperOption">
          <swiper-slide><img src="http://p4.music.126.net/wA1VAVho4hAaD905vNQ7ug==/18557557255414740.jpg" class="banner-item"></swiper-slide>
          <swiper-slide><img src="http://p4.music.126.net/pNl6zq-mkuiwNd8hqlCO_A==/18502581674032523.jpg" class="banner-item"></swiper-slide>
          <swiper-slide><img src="http://p4.music.126.net/KHNm_VvDrLB_VdJ0GPmidg==/18564154325184446.jpg" class="banner-item"></swiper-slide>
          <swiper-slide><img src="http://p4.music.126.net/S37UP-tFdAqsPJnWEslfYA==/18665309394688598.jpg" class="banner-item"></swiper-slide>
      ...
      <mu-flexbox wrap="wrap" justify="space-around" class="box" :gutter="0">
        ...
        <mu-flexbox wrap="wrap" justify="space-around" class="box" :gutter="0">
          ...
          <mu-flexbox-item basis="40%" class="mv-item">
            ...
            <div class="mv-name">Lets show them we are better</div>
            <div class="mv-author">The Chainsmokers</div>
          </mu-flexbox-item>
          <mu-flexbox-item basis="40%" class="mv-item">
            <img class="img-response"  src="http://p3.music.126.net/DNlE0AUQdXci4XaQaxsHPQ==/18643319162278619.jpg?param=300y170">
            <div class="mv-name">Lets show them we are better</div>
